...
# SIMA Pattern Implementation - Core Architectural Choices
...
**File Contents:**
- DEC-01: SIMA pattern choice (CRITICAL)
...
### Decision 1: SIMA Pattern Choice
**REF:** NM04-DEC-01
**PRIORITY:** 🔴 CRITICAL
**TAGS:** SIMA, architecture, gateway, interface, separation-of-concerns
**KEYWORDS:** SIMA pattern, architecture choice, gateway pattern, why SIMA
**RELATED:** NM01-ARCH-01, NM01-ARCH-02, NM02-RULE-01, NM06-LESS-01
**ALIASES:** "why SIMA", "why gateway pattern", "architecture rationale"

**What:** Use SIMA (Single-Interface Multi-Architecture) pattern: Gateway → Interface → Implementation
...
**Rationale:** 
The SIMA pattern is not just about preventing circular imports (though that alone would justify it). It's about creating a system that is:
...
Claude searches: "SIMA pattern why gateway"
Finds: NM04-DEC-01
Response: "SIMA pattern prevents circular imports mathematically, provides centralized control for logging/metrics/caching, enables lazy loading (60ms cold start savings), improves testability, and makes all operations discoverable. The ~100ns overhead per operation is negligible compared to 120x benefits."
```
...
- BUG-02 → Led to DEC-01 (SIMA pattern)
...
**Key Takeaways:**
1. SIMA pattern prevents circular imports mathematically
