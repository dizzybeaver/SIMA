...
💡 Usage:
Upload this file + `File Server URLs.md` at session start.
Say: “Load [Mode Name] using MODE-LOADER-SIMA.md”
I will fetch the correct context file via the cache-busted URL from `fileserver.php`.
...
Keywords: mode, loader, context, SIMA, activation, LEE
