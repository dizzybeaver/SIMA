# NM06-Wisdom-Synthesized_WISD-05.md - WISD-05
...
This wisdom synthesized from multiple documentation lessons (LESS-11, LESS-12, LESS-13) and the creation of SIMA neural maps themselves. Every undocumented decision eventually becomes a mystery. Every lesson not captured is doomed to be relearned painfully.
...
**The Key Insight:** Documentation is an investment in future efficiency.
...
**Example 1: Design Decisions (LESS-11)**
```markdown
...
See: DEC-01 (SIMA pattern choice)
...
- **LESS-11**: Design decisions must be documented (primary source)
- **LESS-12**: Code comments vs external docs (documentation levels)
- **LESS-13**: Architecture must be teachable (enabled by documentation)
- **WISD-02**: Measure don't guess (document measurements)
- **DEC-##**: All design decisions (examples of documentation)

---

## Keywords

documentation, institutional-memory, knowledge-transfer, rationale, context, decision-history

---

## Version History

- **2025-10-23**: Created from synthesis of LESS-11, LESS-12, LESS-13
