...
private function getAssetPaths() {
    // Always use relative paths from the current script location
    $scriptDir = dirname($_SERVER['SCRIPT_NAME']);
    
    // Remove any trailing slashes
    $scriptDir = rtrim($scriptDir, '/');
    
    // If we're in a subdirectory, build paths relative to script
    // Otherwise use root-relative paths
...
<head>
    ...
    <link rel="stylesheet" href="<?= $this->assetPaths['css'] ?>sima-styles.css">
</head>
<body>
    <div class="container">
